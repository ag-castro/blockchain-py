...
class Blockchain:
    ...
    def get_balance(self, sender=None):
        ...
        if sender is None:
            ...
            participant = sender
        # Fetch a list of all sent coin amounts for the given person (empty lists are
        # returned if the person was NOT the sender)
    ...
    def resolve(self):
        ...
        for node in self.__peer_nodes:
            ...
            try:
                ...
                node_chain = [Block(
                    block['index'], block['previous_hash'], [Transaction(
                    tx['sender'], tx['recipient'], tx['signature'], tx['amount']
